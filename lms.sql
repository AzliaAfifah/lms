...
--
-- Host: localhost:3306
-- Generation Time: May 27, 2025 at 04:39 PM
...
CREATE TABLE `coupons` (
  ...
  `coupon_title` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `coupon_announcement` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `coupons` (`id`, `coupon_name`, `coupon_discount`, `coupon_validity`, `coupon_title`, `coupon_announcement`, `status`, `instructor_id`, `course_id`, `created_at`, `updated_at`) VALUES
(2, 'AZLIA', '20', '2025-02-14', NULL, '', 1, NULL, NULL, '2025-02-13 20:31:27', '2025-02-13 20:31:27'),
(3, 'ADMIN', '10', '2025-02-15', NULL, '', 1, NULL, NULL, '2025-02-12 23:21:56', NULL),
(4, 'AFIFAH', '30', '2025-02-16', NULL, '', 1, NULL, NULL, '2025-02-16 06:35:01', NULL),
(5, 'DISKON', '20', '2025-03-31', NULL, '', 1, NULL, NULL, '2025-02-16 19:30:23', NULL),
(9, 'UJIKOM', '20', '2025-05-10', NULL, '', 1, 2, 21, '2025-04-14 08:28:23', NULL),
(10, 'BISMILLAH', '30', '2025-04-30', NULL, '', 1, NULL, NULL, '2025-04-14 17:36:25', '2025-04-14 17:36:25'),
(15, 'ENGLISH', '50', '2025-05-23', 'Special Offer: 50% OFF with Code ENGLISH', 'Unlock your 50% discount on selected items by using the coupon code ENGLISH at checkout.', 1, NULL, NULL, '2025-05-23 03:49:04', '2025-05-23 03:49:04'),
(16, 'SPANISH', '50', '2025-05-23', 'Use Coupon Code: SPANISH and Get 50% Off', 'Ready to level up your Spanish skills? Apply the code SPANISH at checkout and enjoy a 50% discount on your purchase.', 1, 2, 14, '2025-05-23 06:16:38', '2025-05-23 06:16:38');
...
(22, 1, 2, 'upload/course/thambnail/1826901533205258.jpg', 'Business English: Communicate Like a Pro', 'Business English: Communicate Like a Pro', 'business-english:-communicate-like-a-pro', '<p>123</p>', 'upload/course/video/1742269070.mp4', 'Middle', '12', '3', 'Yes', 500, NULL, '123', '1', NULL, '1', 1, '2025-03-17 20:37:50', '2025-04-17 01:15:03');
...
(2, 2, NULL, 'instagram', 'https://www.instagram.com/azzznsrn_/?next=%2F', NULL, '2025-04-26 06:39:12'),
(5, 2, NULL, 'linkedin', '#', NULL, NULL);
...
(5, 42, 'Master\'s Degree', 'Education', 'Harvard University', '2006', 'Australian Independent School', 'Teacher', 'English', '4', '2025-04-16', '2029-04-16', 'I teach english lesson in grade 1 to 6', '1', 'upload/cv/1744782848.pdf', NULL, NULL),
(6, 43, 'Master\'s Degree', 'Computer Science', 'Oxford University', '2006', 'Duolingo', 'Teacher', 'Spanish', '4', '2025-04-16', '2029-04-17', 'I teach spanish in language learning course', '3', 'upload/cv/1744783272.pdf', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `lecture_checklists`
--

CREATE TABLE `lecture_checklists` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
(39, '2025_04_29_152929_create_lecture_checklists_table', 28);
...
(22, 'course.menu', 'web', NULL, '2025-05-24 06:47:59', '2025-05-24 07:51:55'),
(23, 'all.instructor', 'web', 'Instructor', '2025-05-24 06:48:56', '2025-05-24 06:48:56'),
(24, 'pending.instructor', 'web', 'Instructor', '2025-05-24 06:49:13', '2025-05-24 06:49:13'),
(26, 'comment.menu', 'web', 'Comment', '2025-05-24 06:50:38', '2025-05-24 06:50:38'),
(27, 'testimonial.menu', 'web', 'Testimonial', '2025-05-24 06:50:49', '2025-05-24 06:50:49'),
(28, 'blog.add', 'web', 'Blog', '2025-05-24 06:52:20', '2025-05-24 06:52:20'),
(29, 'blog.edit', 'web', 'Blog', '2025-05-24 06:52:30', '2025-05-24 06:52:30'),
(30, 'blog.delete', 'web', 'Blog', '2025-05-24 06:52:41', '2025-05-24 06:52:41'),
(31, 'admin.menu', 'web', 'Admin', '2025-05-24 06:53:43', '2025-05-24 06:53:43');
...
(1, 'Admin', 'admin', 'admin@gmail.com', NULL, '$2y$10$K/vqnSm3BLgaL9PgcrNWCOaeOSD7YHzb0zueEhPkjDCdbAS4joka6', '202412221500cat profile 2.jpg', '1234', 'Indonesia', 'admin', '1', '2025-05-24 14:54:33', NULL, NULL, '2025-05-24 07:54:33'),
(2, 'Instructor', 'instructor', 'instructor@gmail.com', NULL, '$2y$10$/DsOa07xfd4gOcL.M/JUh.gEW22ERgiQx9bmzDoqaeAgereWFNhn6', '202504250419525a256bd065ddffe5bcc3a72121e245.jpg', '993', 'Indonesia', 'instructor', '1', '2025-05-23 14:54:03', NULL, '2025-02-04 07:11:01', '2025-05-23 07:54:03'),
(3, 'User', 'user', 'user@gmail.com', NULL, '$2y$10$9SmCs4RFBq96suBtXs2ICe.8hBTCPhy96dYCVtMp5Cfm623VlTsLa', '202412271457bebek.jpg', '1234567890', 'Sukamaju', 'user', '1', '2025-05-26 11:57:36', 'u1SNDbMCQKQJCqpn2glz99WdPnP1YDb4Sfw3AD2Oys3fql94MnY1YuMR89zu', NULL, '2025-05-26 04:57:36'),
(4, 'Onis', 'onis', 'onis@gmail.com', NULL, '$2y$10$9SmCs4RFBq96suBtXs2ICe.8hBTCPhy96dYCVtMp5Cfm623VlTsLa', '20241227150120240130_050807.jpg', '089525907023', 'Indonesia', 'user', '1', '2025-05-23 10:57:00', NULL, '2024-12-19 05:30:18', '2025-05-23 03:57:00'),
(5, 'Batu Karang', 'batukarang', 'batukarang@gmail.com', NULL, '$2y$10$dM8vlhsaFf7h10MVhAUtZuJrKLOwX2mqKFuhGxPocj8UrQVWxDzBG', '202412271447cat glasses.jpg', '0888', 'BBC', 'user', '1', '2025-05-24 10:55:22', NULL, '2024-12-25 04:13:09', '2025-05-24 03:55:22'),
...
(20, 'Muhammad Abyan', 'Byndewan', 'abyan@abyan.com', NULL, '$2y$10$.STjJSbW2C6mP742jD5rEeTdLyW3dv8xOdTk1/3j90UkXO5bnBFDW', '202503090535WhatsApp Image 2024-08-27 at 22.52.41_b131a581.jpg', '1234567890', 'kepo', 'admin', '1', '2025-05-24 14:46:38', NULL, '2025-03-08 00:40:40', '2025-05-24 07:46:38'),
...
--
-- Indexes for table `lecture_checklists`
--
ALTER TABLE `lecture_checklists`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lecture_checklists_user_id_foreign` (`user_id`),
  ADD KEY `lecture_checklists_course_lecture_id_foreign` (`lecture_id`);
...
--
-- AUTO_INCREMENT for table `lecture_checklists`
--
ALTER TABLE `lecture_checklists`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `lecture_checklists`
--
ALTER TABLE `lecture_checklists`
  ADD CONSTRAINT `lecture_checklists_course_lecture_id_foreign` FOREIGN KEY (`lecture_id`) REFERENCES `course_lectures` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lecture_checklists_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
