...
(37, '2025_04_29_055823_create_lecture_checklists_table', 28);
...
(3, 'User', 'user', 'user@gmail.com', NULL, '$2y$10$9SmCs4RFBq96suBtXs2ICe.8hBTCPhy96dYCVtMp5Cfm623VlTsLa', '202412271457bebek.jpg', '1234567890', 'Sukamaju', 'user', '1', '2025-04-29 07:00:12', 'wvT6TOnSe0Np4HsIxHY2Z7hyysuYqfdhM2di7NvlrPUyVJAAT9jYAGT4RNBb', NULL, '2025-04-29 00:00:12'),
...
ALTER TABLE `lecture_checklists`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `lecture_checklists_user_id_lecture_id_unique` (`user_id`,`lecture_id`),
  ADD KEY `lecture_checklists_lecture_id_foreign` (`lecture_id`);
...
--
ALTER TABLE `lecture_checklists`
  ADD CONSTRAINT `lecture_checklists_lecture_id_foreign` FOREIGN KEY (`lecture_id`) REFERENCES `course_lectures` (`id`) ON DELETE CASCADE,
